...
#   os.system('play -q -v 1.5 $HOME/weather_station/media/de/TL_on.mp3 tempo 1.3 2>&1 >/dev/null')
#   os.system('python $HOME/weather_station/tools/disablePTT.py')
   
   # switch on traffic light
#   os.system('/home/pilot/.local/bin/rpi-rf_send -g 6  -p 323 -t 1 282961 2>&1 >/dev/null')
   os.system('/home/pilot/.local/bin/rpi-rf_send -g 6  -p 323 -t 1 282961')
...
#   os.system('python $HOME/weather_station/tools/enablePTT.py')
#   os.system('play -q -v 1.5 $HOME/weather_station/media/de/TL_off.mp3 tempo 1.3 2>&1 >/dev/null ')   
#   os.system('python $HOME/weather_station/tools/disablePTT.py')
   
   # switch off traffic-light
   os.system('/home/pilot/.local/bin/rpi-rf_send -g 6 -p 323 -t 1 282964 2>&1>/dev/null')
