...
print GENERATE "/home/pilot/weather_station/media/WeatherStation_0.wav /home/pilot/weather_station/ramdisk/weather.mp3 silence 1 0.25 0.1% -1 0.25 0.1%\n";
close(WEATHER);
close(GENERATE);
...
#	print "$carray[$i]\n";
	...
	{
	    print "Error: convert_weather_txt_to_mp3.pl I am ran into $carray[$i]\n";
	}
