...
p.add_argument('-lang', required=True, choices=['en', 'de', 'it'], help='Required: Language for transcoding Weather Options are \"en\", \"de\" and \"it".')
args = p.parse_args()
lang = args.lang
...
#  WeatherStation_intro ... WeatherStation_zulu
